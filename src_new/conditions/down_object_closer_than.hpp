...
namespace RSLA
{
    ...
    class DownObjectCloserThan : public BT::ConditionNode
    {
    public:
        DownObjectCloserThan(const std::string& name, const BT::NodeConfig& config,
        ...
        BT::NodeStatus tick() override
        {
            ...
            if(node_->downDetections[class_id.value()].distance < distance.value())
            {
