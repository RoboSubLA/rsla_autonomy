...
namespace RSLA
{
    ...
    class DownCanSeeObject : public BT::ConditionNode
    {
    public:
        DownCanSeeObject(const std::string& name, const BT::NodeConfig& config,
        ...
        BT::NodeStatus tick() override
        {
            ...
            if(node_->downDetections[class_id.value()].detected_now)
            {
