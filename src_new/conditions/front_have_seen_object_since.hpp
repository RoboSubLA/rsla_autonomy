...
namespace RSLA
{
    ...
    class FrontHaveSeenObjectSince : public BT::ConditionNode
    {
    public:
        FrontHaveSeenObjectSince(const std::string& name, const BT::NodeConfig& config,
        ...
        BT::NodeStatus tick() override
        {
            ...
            if(node_->frontDetections[class_id.value()].millis_since_seen < timeout.value())
            {
