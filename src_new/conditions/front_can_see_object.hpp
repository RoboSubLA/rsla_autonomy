...
namespace RSLA
{
    ...
    class FrontCanSeeObject : public BT::ConditionNode
    {
    public:
        FrontCanSeeObject(const std::string& name, const BT::NodeConfig& config,
        ...
        BT::NodeStatus tick() override
        {
            ...
            if(node_->frontDetections[class_id.value()].detected_now)
            {
