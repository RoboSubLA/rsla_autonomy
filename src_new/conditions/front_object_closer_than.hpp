...
namespace RSLA
{
    ...
    class FrontObjectCloserThan : public BT::ConditionNode
    {
    public:
        FrontObjectCloserThan(const std::string& name, const BT::NodeConfig& config,
        ...
        BT::NodeStatus tick() override
        {
            ...
            if(node_->frontDetections[class_id.value()].distance < distance.value())
            {
