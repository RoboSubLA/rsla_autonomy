...
namespace RSLA
{
    ...
    class DownHaveSeenObjectSince : public BT::ConditionNode
    {
    public:
        DownHaveSeenObjectSince(const std::string& name, const BT::NodeConfig& config,
        ...
        BT::NodeStatus tick() override
        {
            ...
            if(node_->downDetections[class_id.value()].millis_since_seen < timeout.value())
            {
